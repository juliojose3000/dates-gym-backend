...
public class EmailHtmlBodies {
	...
	public String generateResetPasswordLinkEmailBody(String username, String codeReset) {
		return "<div style=\"width: 100%;height: 100%;\">\r\n"
				...
				+ "		<h3 style=\"color: white; \">Has solicitado crear una nueva contraseña</h3>\r\n"
				+ "		<p style=\"color: white;\">Hola "+username+", para poder proceder, has click en el botón de abajo</p>\r\n"
				+ "\r\n"
