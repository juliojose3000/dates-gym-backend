...
public class Utilities {
	...
	public static String applyMaskToPhoneNumber(String phone) {
		final int mid = phone.length() / 2; // get the middle of the String
		String[] parts = { phone.substring(0, mid), phone.substring(mid) };
